...
-   Querying the DNS Database
    ...
    A recursive query puts the entire burden on a single DNS server, while an iterative query requires the client to do the legwork of querying multiple servers step-by-step
